...
base_dir = Path(r"C:\Users\ander\OneDrive\Documentos\Mestrado\Disciplinas\3º Período\estudo-dirigido\fair_post-process_experiments\artifacts\base")
experiment_dir = base_dir / DATASET / f"seed_{RANDOM_STATE}" / experiment_date

#-----------------------------------------------------------------------------
# Dados completos
#-----------------------------------------------------------------------------

base_artifact = np.load(experiment_dir)
